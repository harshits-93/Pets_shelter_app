...
public class EditorActivity extends AppCompatActivity {
    ...
    private void insertPets() {
        ...
        contentValues.put(PetsEntry.COLUMN_PET_NAME, stringName);
        contentValues.put(PetsEntry.COLUMN_PET_BREED, stringBreed);
        contentValues.put(PetsEntry.COLUMN_PET_GENDER, gender);
