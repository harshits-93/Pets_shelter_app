...
public class EditorActivity extends AppCompatActivity implements LoaderManager.LoaderCallbacks<Cursor> {
    ...
    private static final int EXISTING_PETS_LOADER = 0;
...
// the view, and we change the mPetHasChanged boolean to true.
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Log.e(TAG, "URI of the clicked item : " + mCurrentPetUri);
        ...
        if (mCurrentPetUri == null) {
            ...
            getSupportLoaderManager().initLoader(EXISTING_PETS_LOADER, null, this);
        }
        setupSpinner();
    ...
    private void savePet() {
        ...
        if (mCurrentPetUri == null &&
                TextUtils.isEmpty(stringName) && TextUtils.isEmpty(stringBreed) &&
